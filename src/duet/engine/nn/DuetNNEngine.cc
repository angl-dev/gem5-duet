...
DuetEngine::softreg_id_t DuetNNEngine::get_num_softregs () const {
...
unsigned DuetNNEngine::get_max_stats_waittime () const {
    return 5000;
}

unsigned DuetNNEngine::get_max_stats_exectime () const {
    return 2000;
}

bool DuetNNEngine::handle_softreg_write (
...
bool DuetNNEngine::handle_softreg_read (
        DuetEngine::softreg_id_t    softreg_id
        , uint64_t                & value
        )
{

...
DuetEngine::softreg_id_t DuetKNNEngine::get_num_softregs () const {
    return num_softreg_per_caller * (get_num_callers () + 1);
}

DuetFunctor::caller_id_t DuetKNNEngine::get_num_memory_chans () const {
    return 1;
}

DuetFunctor::caller_id_t DuetKNNEngine::get_num_interlane_chans () const {
    return 3;
}

unsigned DuetKNNEngine::get_max_stats_waittime () const {
    return 5000;
}

unsigned DuetKNNEngine::get_max_stats_exectime () const {
    return 2000;
}

bool DuetKNNEngine::handle_softreg_write (
...
bool DuetKNNEngine::handle_softreg_read (
        DuetEngine::softreg_id_t    softreg_id
        , uint64_t                & value
        )
{
...
void DuetKNNEngine::try_send_mem_req_all () {
    try_send_mem_req_one ( 0 );
}

void DuetKNNEngine::init () {
    DuetEngine::init ();
